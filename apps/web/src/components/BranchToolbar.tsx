...
export default function BranchToolbar({
  ...
  return (
    <div className="@container/branch-toolbar mx-auto flex w-full max-w-3xl min-w-0 items-center justify-between gap-2 overflow-hidden px-3 pb-3 pt-1 sm:px-5">
      <div className="flex min-w-0 shrink items-center gap-2">
        {envLocked || activeWorktreePath ? (
          ...
          <div className="inline-flex min-w-0 items-center gap-1 rounded border border-foreground/10 bg-background/60 p-1 shadow-[0_8px_24px_-20px_rgba(0,0,0,0.65)]">
            <button
              type="button"
              className={cn(
                "inline-flex h-8 items-center justify-center rounded px-2.5 text-xs font-semibold whitespace-nowrap transition-colors @lg/branch-toolbar:h-9 @lg/branch-toolbar:px-4 @lg/branch-toolbar:text-sm",
