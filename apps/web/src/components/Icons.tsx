...
export const PullRequestIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
    <circle cx="4" cy="3" r="1.5" fill="currentColor" stroke="none" />
    <circle cx="4" cy="13" r="1.5" fill="currentColor" stroke="none" />
    <circle cx="12" cy="5" r="1.5" fill="currentColor" stroke="none" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4.75v4.5c0 1.1.9 2 2 2h3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 11.5V6.75c0-1.1.9-2 2-2h3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="m8.75 3.5 2.25 1.5-2.25 1.5" />
  </svg>
);
